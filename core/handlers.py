# Обработчики исключений для FastAPI: централизованно обрабатывают ошибки приложения, валидации, конфликты БД и неожиданные сбои, возвращая единообразные JSON-ответы.
