# Главный роутер API: объединяет все модули (авторизация, хобби, пользователи, посты, лайки, чаты) и предоставляет корневой эндпоинт для проверки работоспособности.
