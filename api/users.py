# Роутер пользователей: предоставляет эндпоинты для получения базовой и расширенной информации о текущем пользователе, а также для создания или обновления профиля (хобби, цели, дополнительные данные).
